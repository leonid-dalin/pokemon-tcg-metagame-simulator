...
BDIF_POSTERIOR_DRAWS = 200
BDIF_MIN_ITERATIONS_PER_DRAW = 100
BDIF_MIN_INTERVAL_DRAWS = 50
BDIF_FIELD_POSTERIOR_DRAWS = 2_000
BDIF_PANEL_SHARE_THRESHOLD = 0.03
BDIF_PANEL_MAX_DECKS = 10
BDIF_CARD_MIN_PLAYERS = 50
BDIF_CARD_MIN_WITHIN_RATE = 0.05
BDIF_CARD_MAX_WITHIN_RATE = 0.95
BDIF_CARD_MAX_ABS_LOGIT = 5.0
